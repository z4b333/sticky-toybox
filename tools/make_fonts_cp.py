...
firmware carries. Toybox's layouts assume line boxes of 12 / 16 / 24 / 32 px;
...
BUCKETS = [
    ('12', 'notosans_8_regular', None),                    # TS_SMALL  -> SMALL_FONT_ID
    ('16', 'ubuntu_10_regular', 'ubuntu_10_bold'),         # TS_MED    -> UI_10_FONT_ID
    ('24', 'ubuntu_12_regular', 'ubuntu_12_bold'),         # TS_LARGE  -> UI_12_FONT_ID
    ('32', 'notosans_18_regular', 'notosans_18_bold'),     # TS_HUGE   -> NOTOSANS_18_FONT_ID
]
...
def main():
    ...
    print('// Heights are 23 / 24 / 29 / 51 against the 12 / 16 / 24 / 32 the layouts')
